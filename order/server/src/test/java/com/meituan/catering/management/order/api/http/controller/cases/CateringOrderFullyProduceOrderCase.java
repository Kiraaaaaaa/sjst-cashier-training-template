...
public class CateringOrderFullyProduceOrderCase extends BaseCateringOrderControllerCase {
    ...
    private void buildRequestItem2(ProduceCateringOrderHttpRequest httpRequest) {
        ProduceCateringOrderHttpRequest.Item itemHttpRequest2 = new ProduceCateringOrderHttpRequest.Item();
        itemHttpRequest2.setSeqNo("2");
        itemHttpRequest2.setVersion(2);
        itemHttpRequest2.setQuantityOnProduce(BigDecimal.ONE);
    ...
    private void buildRequestItem3(ProduceCateringOrderHttpRequest httpRequest) {
        ...
        itemHttpRequest3.setQuantityOnProduce(BigDecimal.valueOf(3));
    ...
    private void buildRequestItem6WithAccessories(ProduceCateringOrderHttpRequest httpRequest) {
        ...
        itemHttpRequest6.setQuantityOnProduce(BigDecimal.valueOf(3));
        // Item 6 - Accessory 1
        ProduceCateringOrderHttpRequest.Item.Accessory accessory61 = new ProduceCateringOrderHttpRequest.Item.Accessory();
        accessory61.setSeqNo("6-1");
        accessory61.setVersion(3);
        accessory61.setQuantityOnProduce(BigDecimal.valueOf(3));
        itemHttpRequest6.getAccessories().add(accessory61);
        // Item 6 - Accessory 2
        ProduceCateringOrderHttpRequest.Item.Accessory accessory62 = new ProduceCateringOrderHttpRequest.Item.Accessory();
        accessory62.setSeqNo("6-2");
        accessory62.setVersion(3);
        accessory62.setQuantityOnProduce(BigDecimal.valueOf(6));
    ...
    private void assertOrderItem2(CateringOrderDetailHttpResponse response) {
        ...
        // 1 = 0 + 1
        assertEquals(new BigDecimal("1.00"), item2.getQuantity().getOnProduce());
        assertEquals(CateringOrderItemStatusEnum.PREPARED, item2.getStatus());
    }
    ...
    private void assertOrderItem3(CateringOrderDetailHttpResponse response) {
        ...
        // 3 = 0 + 3
        assertEquals(new BigDecimal("3.00"), item3.getQuantity().getOnProduce());
        assertEquals(CateringOrderItemStatusEnum.PREPARED, item3.getStatus());
    }
    ...
    private void assertOrderItem5(CateringOrderDetailHttpResponse response) {
        ...
        // 3 = 3
        assertEquals(new BigDecimal("3.00"), item5.getQuantity().getOnProduce());
    ...
    private void assertOrderItem6WithAccessories(CateringOrderDetailHttpResponse response) {
        ...
        // 4 = 1 + 3
        assertEquals(new BigDecimal("4.00"), item6.getQuantity().getOnProduce());
        assertEquals(CateringOrderItemStatusEnum.PREPARED, item6.getStatus());
        // Item 6 - Accessories
        assertEquals(2, item6.getAccessories().size());
        // Item 6 - Accessory 1
        CateringOrderDetailHttpResponse.Item.Accessory accessory1 = item6.getAccessories().get(0);
        assertEquals(Integer.valueOf(4), accessory1.getVersion());
        // 4 = 1 + 3
        assertEquals(new BigDecimal("4.00"), accessory1.getQuantity().getOnProduce());
        // Item 6 - Accessory 2
        CateringOrderDetailHttpResponse.Item.Accessory accessory2 = item6.getAccessories().get(1);
        assertEquals(Integer.valueOf(4), accessory2.getVersion());
        // 8 = 2 + 6
        assertEquals(new BigDecimal("8.00"), accessory2.getQuantity().getOnProduce());
    }
}
